...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsAntiCheat:1;
             u16 optionsAutoReplenishBerries:1;
             //u16 padding1:2;
...
struct Roamer
{
    u32 ivs;
    u32 personality;
    u16 species:11; // up to 2047 different species
    ...
    bool8 doesNotFlee:1;
    bool8 isStalker:1;
    bool8 levelScaling:1;
    bool8 hideFromDex:1;
    u8 nocturnality:2;
    u8 locationMapGroup;
    u8 locationMapNum;
    u8 mapGroupHistory[3];
    u8 mapNumHistory[3];
}; /*size = 0x18*/
...
struct SaveBlock1
{
    ...
    /*0x560*/ struct ItemSlot bagPocket_Consumables[BAG_ITEMS_COUNT];
