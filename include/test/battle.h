...
struct BattleTestData
{
    ...
    u8 gender;
    u8 nature;
    u16 forcedAbilities[NUM_BATTLE_SIDES][PARTY_SIZE][NUM_ABILITIES];
...
#define Innate(ability) Innate_(__LINE__, ability)
...
#define HiddenPower(type) HiddenPower_(__LINE__, type)
