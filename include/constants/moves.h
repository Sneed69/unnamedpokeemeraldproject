...
#define MOVE_FAIRY_TAIL CUSTOM_MOVES_START + 2
#define MOVE_COLD_SNAP CUSTOM_MOVES_START + 3
#define MOVE_BLISTERING_COLD CUSTOM_MOVES_START + 4
#define MOVE_HOWLING_GALE CUSTOM_MOVES_START + 5
#define MOVE_ACID_RAIN CUSTOM_MOVES_START + 6
#define MOVE_MAGIC_FANG CUSTOM_MOVES_START + 7
