...
//CUSTOM MOVES
#define CUSTOM_MOVES_START MOVES_COUNT_GEN9
#define MOVE_MYSTIC_BLADES   (CUSTOM_MOVES_START)
#define MOVE_FAIRY_TAIL      (CUSTOM_MOVES_START + 1)
#define MOVE_COLD_SNAP       (CUSTOM_MOVES_START + 2)
#define MOVE_BLISTERING_COLD (CUSTOM_MOVES_START + 3)
#define MOVE_HOWLING_GALE    (CUSTOM_MOVES_START + 4)
#define MOVE_ACID_RAIN       (CUSTOM_MOVES_START + 5)
#define MOVE_MAGIC_FANG      (CUSTOM_MOVES_START + 6)
#define MOVE_STARFALL        (CUSTOM_MOVES_START + 7)
#define MOVE_OVERLOAD        (CUSTOM_MOVES_START + 8)
#define MOVE_BLOOM           (CUSTOM_MOVES_START + 9)
#define MOVE_MINDSTORM       (CUSTOM_MOVES_START + 10)
#define MOVE_GEYSER          (CUSTOM_MOVES_START + 11)
#define MOVE_FLARE           (CUSTOM_MOVES_START + 12)
#define MOVE_SNOWSTORM       (CUSTOM_MOVES_START + 13)
#define MOVE_LANDSLIDE       (CUSTOM_MOVES_START + 14)
#define MOVE_TORNADO         (CUSTOM_MOVES_START + 15)
#define MOVE_VAMPIRIC_FANG   (CUSTOM_MOVES_START + 16)
#define MOVE_TOPPLE_PSYCHE   (CUSTOM_MOVES_START + 17)
#define MOVE_DUST_DEVIL      (CUSTOM_MOVES_START + 18)

#define MOVES_COUNT          (CUSTOM_MOVES_START + 19)
