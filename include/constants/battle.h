...
#define STATUS_FIELD_POLLUTED_TERRAIN               (1 << 10)
...
#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_POLLUTED_TERRAIN)
...
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_WINDY | B_WEATHER_SNOW | B_WEATHER_FOG)
...
#define B_WEATHER_WINDY_TEMPORARY     (1 << 14)
#define B_WEATHER_WINDY_PERMANENT     (1 << 15)
#define B_WEATHER_WINDY               (B_WEATHER_WINDY_TEMPORARY | B_WEATHER_WINDY_PERMANENT | B_WEATHER_STRONG_WINDS)
