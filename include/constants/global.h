...
#define ROAMER_COUNT 15 // Number of maximum concurrent active roamers
...
#define ABILITY_NAME_LENGTH ((B_EXPANDED_ABILITY_NAMES == TRUE) ? 18 : 12)
...
#define OPTIONS_ANTICHEAT_OFF 0
#define OPTIONS_ANTICHEAT_ON 1
