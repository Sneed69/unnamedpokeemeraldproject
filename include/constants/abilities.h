...
#define ABILITY_DESERT_LURKER      (ABILITIES_CUSTOM_START + 24)
...
#define ABILITY_LOUD_SLEEPER       (ABILITIES_CUSTOM_START + 37)

#define ABILITIES_COUNT            (ABILITIES_CUSTOM_START + 38)
