...
// Custom
#define ABILITIES_CUSTOM_START ABILITIES_COUNT_GEN9
#define ABILITY_TRANSCENDENCE      ABILITIES_CUSTOM_START
#define ABILITY_IONIZATION         (ABILITIES_CUSTOM_START + 1)
#define ABILITY_CRYOPHILIC         (ABILITIES_CUSTOM_START + 2)
#define ABILITY_UNBREAKABLE        (ABILITIES_CUSTOM_START + 3)
#define ABILITY_UNTHREATENING      (ABILITIES_CUSTOM_START + 4)
#define ABILITY_NINE_LIVES         (ABILITIES_CUSTOM_START + 5)
#define ABILITY_COUNTERSPELL       (ABILITIES_CUSTOM_START + 6)
#define ABILITY_TECTONIC_BALANCE   (ABILITIES_CUSTOM_START + 7)
#define ABILITY_ABSOLUTE_ZERO      (ABILITIES_CUSTOM_START + 8)
#define ABILITY_PERFECT_ALLOY      (ABILITIES_CUSTOM_START + 9)
#define ABILITY_MIGHT_OF_THE_AGES  (ABILITIES_CUSTOM_START + 10)
#define ABILITY_CONDENSED_ENERGY   (ABILITIES_CUSTOM_START + 11)
#define ABILITY_OVERTURN           (ABILITIES_CUSTOM_START + 12)
#define ABILITY_PRISTINE_PLUMAGE   (ABILITIES_CUSTOM_START + 13)
#define ABILITY_HEAVILY_ARMED      (ABILITIES_CUSTOM_START + 14)
#define ABILITY_MALEDICTION        (ABILITIES_CUSTOM_START + 15)
#define ABILITY_SHINING_BEACON     (ABILITIES_CUSTOM_START + 16)
#define ABILITY_FLIGHTLESS         (ABILITIES_CUSTOM_START + 17)
#define ABILITY_JET_STREAM         (ABILITIES_CUSTOM_START + 18)
#define ABILITY_AERODYNAMIC        (ABILITIES_CUSTOM_START + 19)
#define ABILITY_POWER_GLIDE        (ABILITIES_CUSTOM_START + 20)
#define ABILITY_SPOON_BENDER       (ABILITIES_CUSTOM_START + 21)
#define ABILITY_OVERFLOW           (ABILITIES_CUSTOM_START + 22)
#define ABILITY_CRYSTAL_SHROUD     (ABILITIES_CUSTOM_START + 23)
#define ABILITY_DESERT_DWELLER     (ABILITIES_CUSTOM_START + 24)
#define ABILITY_NOXIOUS_SURGE      (ABILITIES_CUSTOM_START + 25)
#define ABILITY_MISCHIEVOUS        (ABILITIES_CUSTOM_START + 26)
#define ABILITY_BLOODSUCKER        (ABILITIES_CUSTOM_START + 27)
#define ABILITY_SOUL_SIPHON        (ABILITIES_CUSTOM_START + 28)
#define ABILITY_FLAMBOYANT         (ABILITIES_CUSTOM_START + 29)
#define ABILITY_EXPERT_TRAPPER     (ABILITIES_CUSTOM_START + 30)
#define ABILITY_BOTANIST           (ABILITIES_CUSTOM_START + 31)
#define ABILITY_LAPIDARY           (ABILITIES_CUSTOM_START + 32)
#define ABILITY_LONE_WOLF          (ABILITIES_CUSTOM_START + 33)
#define ABILITY_VICTORY_RUSH       (ABILITIES_CUSTOM_START + 34)
#define ABILITY_ADRENALINE_RUSH    (ABILITIES_CUSTOM_START + 35)
#define ABILITY_MOMENTUM           (ABILITIES_CUSTOM_START + 36)
#define ABILITY_DOPEY              (ABILITIES_CUSTOM_START + 37)
#define ABILITY_RAZOR_SHARP        (ABILITIES_CUSTOM_START + 38)
#define ABILITY_FLAWLESS_CREATION  (ABILITIES_CUSTOM_START + 39)
#define ABILITY_TIMELESS_BEHEMOTH  (ABILITIES_CUSTOM_START + 40)
#define ABILITY_FRIGHTEN           (ABILITIES_CUSTOM_START + 41)
#define ABILITY_APOSEMATISM        (ABILITIES_CUSTOM_START + 42)
#define ABILITY_SHADOW_TECHNIQUES  (ABILITIES_CUSTOM_START + 43)
#define ABILITY_HALO               (ABILITIES_CUSTOM_START + 44)
#define ABILITY_EMPATH             (ABILITIES_CUSTOM_START + 45)
#define ABILITY_AVENGER            (ABILITIES_CUSTOM_START + 46)
#define ABILITY_HEAVY_IMPACT       (ABILITIES_CUSTOM_START + 47)
#define ABILITY_STONE_CARAPACE     (ABILITIES_CUSTOM_START + 48)
#define ABILITY_VERSATILE          (ABILITIES_CUSTOM_START + 49)
#define ABILITY_BOUNCY             (ABILITIES_CUSTOM_START + 50)

#define ABILITIES_COUNT            (ABILITIES_CUSTOM_START + 51)
