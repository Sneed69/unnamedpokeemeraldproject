...
#define EVO_LEVEL_ABILITY_1               35     // Pokémon reaches the specified level and has the first ability.
#define EVO_LEVEL_ABILITY_2               36     // Pokémon reaches the specified level and has the second ability.
