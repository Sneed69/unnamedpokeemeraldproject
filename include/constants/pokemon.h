...
#define STAT_ATTACK    STAT_ATK
#define STAT_DEFENSE   STAT_DEF
#define STAT_SPATTACK  STAT_SPATK
#define STAT_SPDEFENSE STAT_SPDEF

// Held Item Chances
#define ITEM_CHANCE_COMMON          25
#define ITEM_CHANCE_RARE             5
// With Compound Eyes or Super Luck
#define ITEM_CHANCE_ABILITY_COMMON  44
#define ITEM_CHANCE_ABILITY_RARE    10
...
#define EVO_LEVEL_ABILITY_1               53     // Pokémon reaches the specified level and has its first ability.
#define EVO_LEVEL_ABILITY_2               54     // Pokémon reaches the specified level and has its second ability.
#define EVO_LEVEL_MOVE_TYPE               55     // Pokémon levels up, knows move with specified type
...
#if !TESTING
#define PROFICIENCY_BONUS_MAJOR 45
#define PROFICIENCY_BONUS_MINOR 30
#else
#define PROFICIENCY_BONUS_MAJOR 0
#define PROFICIENCY_BONUS_MINOR 0
#endif
