...
#define EVO_LEVEL_ABILITY_1               43     // Pokémon reaches the specified level and has the first ability.
#define EVO_LEVEL_ABILITY_2               44     // Pokémon reaches the specified level and has the second ability.
#define EVO_MOVE_TYPE                     45     // Pokémon levels up, knows move with specified type
