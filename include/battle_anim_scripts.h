...
extern const u8 Move_MYSTIC_BLADES[];
extern const u8 Move_FAIRY_TAIL[];
extern const u8 Move_COLD_SNAP[];
extern const u8 Move_BLISTERING_COLD[];
extern const u8 Move_HOWLING_GALE[];
extern const u8 Move_ACID_RAIN[];
extern const u8 Move_MAGIC_FANG[];
extern const u8 Move_STARFALL[];
extern const u8 Move_OVERLOAD[];
extern const u8 Move_BLOOM[];
extern const u8 Move_MINDSTORM[];
extern const u8 Move_GEYSER[];
extern const u8 Move_FLARE[];
extern const u8 Move_SNOWSTORM[];
extern const u8 Move_LANDSLIDE[];
extern const u8 Move_TORNADO[];
extern const u8 Move_VAMPIRIC_FANG[];
extern const u8 Move_TOPPLE_PSYCHE[];
extern const u8 Move_DUST_DEVIL[];
