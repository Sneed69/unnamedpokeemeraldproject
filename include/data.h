...
struct Trainer
{
    ...
    /*0x08*/ u8 trainerClass;
    /*0x09*/ u8 encounterMusic_gender; // last bit is gender
    /*0x10*/ u8 trainerPic;
    /*0x1a*/ u8 trainerName[TRAINER_NAME_LENGTH + 1];
    /*0x1c*/ bool8 doubleBattle:1;
             u8 partySize;
