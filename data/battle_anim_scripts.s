...
Move_U_TURN:
	...
	monbg ANIM_DEF_PARTNER
	setalpha 12, 8
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_ROUND_SHADOW, 0, 0xF, 0xD, RGB(0, 16, 0)
...
Move_METEOR_BEAM:
	...
	waitbgfadein
	choosetwoturnanim MeteorBeamSetUp, MeteorBeamUnleash
MeteorBeamEnd:
	restorebg
	waitbgfadeout
	setarg 7, 0xFFFF
...
MeteorBeamUnleash:
	...
	createvisualtask AnimTask_FlashAnimTagWithColor, 2, ANIM_TAG_ORBS, 1, 12, RGB(31, 31, 15), 16, 0, 0
	call HyperBeamOrbs
	call HyperBeamOrbs
	call HyperBeamOrbs
	call HyperBeamOrbs
...
Move_WAVE_CRASH:
	...
	createvisualtask AnimTask_ShakeMon, 2, ANIM_ATTACKER, 0, 2, 23, 2
	delay 80
	createsprite gSlideMonToOffsetSpriteTemplate, ANIM_ATTACKER, 2, 0, 36, 1, 0, 4
	delay 0x6
	launchtemplate gBasicHitSplatSpriteTemplate 0x2 0x4 0x0 0x9 0x1 0x1
	launchtask AnimTask_ShakeMon 0x2 0x5 0x1 0x3 0x0 0x6 0x1
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	delay 8
	call RisingWaterHitEffect
...
Status_Freeze:
	...
	monbg ANIM_DEF_PARTNER
	createvisualtask AnimTask_BlendBattleAnimPal, 10, 4, 2, 0, 9, RGB(12, 26, 31)
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_ATTACKER, 1, 0, 18, 3
	call IceCrystalEffectShort
	waitforvisualfinish
	createvisualtask AnimTask_BlendBattleAnimPal, 10, 4, 2, 9, 0, RGB(12, 26, 31)
	clearmonbg ANIM_DEF_PARTNER
