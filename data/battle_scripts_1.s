...
gBattleScriptsForMoveEffects::
	...
	.4byte BattleScript_EffectEvasionDownHit		  @ EFFECT_EVASION_DOWN_HIT
...
BattleScript_EffectHealPulse:
    ...
    jumpifability BS_TARGET, ABILITY_WONDER_GUARD, BattleScript_MoveUsedHealBlockPrevents
	accuracycheck BattleScript_ButItFailed, NO_ACC_CALC_CHECK_LOCK_ON
	jumpifsubstituteblocks BattleScript_ButItFailed
...
BattleScript_EffectTripleKick::
	...
	addbyte sTRIPLE_KICK_POWER, 15 @ triple kick gets +15 power
	goto BattleScript_HitFromAtkString
...
BattleScript_WaveCrashSpeedUp::
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_WaveCrashEnd
...
BattleScript_UnthreateningActivatesLoop:
	...
	setstatchanger STAT_DEF, 1, TRUE
	statbuffchange STAT_CHANGE_NOT_PROTECT_AFFECTED | STAT_CHANGE_ALLOW_PTR, BattleScript_UnthreateningTrySpDef
...
BattleScript_UnthreateningTrySpDef:
	setstatchanger STAT_SPDEF, 1, TRUE
	statbuffchange STAT_CHANGE_NOT_PROTECT_AFFECTED | STAT_CHANGE_ALLOW_PTR, BattleScript_UnthreateningActivatesLoopIncrement
