...
BattleScript_MoveMissedDoDamage::
	...
	jumpifability BS_ATTACKER, ABILITY_BOUNCY, BattleScript_PrintMoveMissed
	attackstring
	ppreduce
	pause B_WAIT_TIME_LONG
	resultmessage
...
BattleScript_MoveEffectToxic::
	statusanimation BS_EFFECT_BATTLER
	printfromtable gGotToxicStringIds
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_UpdateEffectStatusIconRet
...
BattleScript_MoveEffectRecoilAbilityPopup::
	jumpifmove MOVE_STRUGGLE, BattleScript_DoRecoil
	jumpifability BS_ATTACKER, ABILITY_ROCK_HEAD, BattleScript_RecoilEnd
	jumpifability BS_ATTACKER, ABILITY_MAGIC_GUARD, BattleScript_RecoilEnd
	jumpifability BS_ATTACKER, ABILITY_BOUNCY, BattleScript_RecoilEnd
	call BattleScript_AbilityPopUp
	goto BattleScript_DoRecoil
...
BattleScript_CondensedEnergyActivates::
	...
	playstatchangeanimation BS_ATTACKER, BIT_SPATK | BIT_SPDEF, 0
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_CondensedEnergyTrySpDef
...
BattleScript_CondensedEnergyTrySpDef::
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_CondensedEnergyEnd
...
BattleScript_EmergencyExitNoPopUp::
	playanimation BS_TARGET, B_ANIM_BOUNCY
	flushtextbox
	waitanimation
...
BattleScript_PollutedSurgeActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printstring STRINGID_TERRAINBECOMESPOLLUTED
	waitmessage B_WAIT_TIME_LONG
	playanimation BS_SCRIPTING, B_ANIM_RESTORE_BG
	call BattleScript_ActivateTerrainEffects
	end3
...
BattleScript_LoneWolf::
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_ATK, MAX_STAT_STAGE, BattleScript_LoneWolfAtk
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_DEF, MAX_STAT_STAGE, BattleScript_LoneWolfAtk
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPEED, MAX_STAT_STAGE, BattleScript_LoneWolfAtk
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPATK, MAX_STAT_STAGE, BattleScript_LoneWolfAtk
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPDEF, MAX_STAT_STAGE, BattleScript_LoneWolfEnd
BattleScript_LoneWolfAtk:
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_ATK | BIT_DEF | BIT_SPEED | BIT_SPATK | BIT_SPDEF, 0
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LoneWolfDef
BattleScript_LoneWolfDef:
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LoneWolfSpeed
BattleScript_LoneWolfSpeed:
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LoneWolfSpAtk
BattleScript_LoneWolfSpAtk:
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LoneWolfSpDef
BattleScript_LoneWolfSpDef:
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LoneWolfEnd
	printstring STRINGID_BATTLERABILITYRAISEDALLSTATS
	waitmessage B_WAIT_TIME_LONG
	copybyte gBattlerAttacker, sSAVED_BATTLER
BattleScript_LoneWolfEnd:
	end3
...
BattleScript_AbilityHealAndCureReturn::
	call BattleScript_AbilityPopUp
	jumpiffullhp BS_ABILITY_BATTLER, BattleScript_AbilityHealAndCureReturn_TryCureStatus
	printstring STRINGID_PKMNSXRESTOREDHP
	waitmessage B_WAIT_TIME_LONG
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE
	healthbarupdate BS_ABILITY_BATTLER
	datahpupdate BS_ABILITY_BATTLER
BattleScript_AbilityHealAndCureReturn_TryCureStatus:
	jumpifpollutedterrainaffected BS_ABILITY_BATTLER, BattleScript_AbilityHealAndCureReturn_End
	jumpifstatus BS_ABILITY_BATTLER, STATUS1_ANY, BattleScript_AbilityHealAndCureReturn_CureStatus
	goto BattleScript_AbilityHealAndCureReturn_End
BattleScript_AbilityHealAndCureReturn_CureStatus:
	curestatus BS_ABILITY_BATTLER
	printstring STRINGID_PKMNSXCUREDYPROBLEM
	waitmessage B_WAIT_TIME_LONG
	updatestatusicon BS_ABILITY_BATTLER
BattleScript_AbilityHealAndCureReturn_End:
	return

BattleScript_AbilityHealAndCureEnd3::
	call BattleScript_AbilityPopUp
	jumpiffullhp BS_ABILITY_BATTLER, BattleScript_AbilityHealAndCureEnd3_TryCureStatus
	printstring STRINGID_PKMNSXRESTOREDHP
	waitmessage B_WAIT_TIME_LONG
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE
	healthbarupdate BS_ABILITY_BATTLER
	datahpupdate BS_ABILITY_BATTLER
BattleScript_AbilityHealAndCureEnd3_TryCureStatus:
	jumpifpollutedterrainaffected BS_ABILITY_BATTLER, BattleScript_AbilityHealAndCureEnd3_End
	jumpifstatus BS_ABILITY_BATTLER, STATUS1_ANY, BattleScript_AbilityHealAndCureEnd3_CureStatus
	goto BattleScript_AbilityHealAndCureEnd3_End
BattleScript_AbilityHealAndCureEnd3_CureStatus:
	curestatus BS_ABILITY_BATTLER
	printstring STRINGID_PKMNSXCUREDYPROBLEM
	waitmessage B_WAIT_TIME_LONG
	updatestatusicon BS_ABILITY_BATTLER
BattleScript_AbilityHealAndCureEnd3_End:
	end3
...
BattleScript_SoulSiphon::
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNDRAINEDDEFSOUL
	waitmessage B_WAIT_TIME_LONG
	orword gHitMarker, HITMARKER_IGNORE_BIDE | HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_IGNORE_DISGUISE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
...
BattleScript_ActivateTeraformZero::
	call BattleScript_AbilityPopUp
	waitmessage B_WAIT_TIME_LONG
	jumpifword CMP_COMMON_BITS, gBattleWeather, B_WEATHER_ANY, BattleScript_ActivateTeraformZero_RemoveWeather
