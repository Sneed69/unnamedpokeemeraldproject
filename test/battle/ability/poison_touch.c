...
SINGLE_BATTLE_TEST("Poison Touch has a 50% chance to poison when attacking with contact moves")
{
    PASSES_RANDOMLY(5, 10, RNG_POISON_TOUCH);
    GIVEN {
        ...
        MESSAGE("Foe Alakazam was badly poisoned by Grimer's Poison Touch!");
