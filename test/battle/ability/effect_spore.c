...
SINGLE_BATTLE_TEST("Effect Spore only inflicts status on contact")
{
    ...
    GIVEN {
        ...
        if (gMovesInfo[move].makesContact) {
            ...
            MESSAGE("Alakazam was poisoned by Foe Breloom's Effect Spore!");
...
SINGLE_BATTLE_TEST("Effect Spore causes paralysis 10% of the time")
{
    ...
    GIVEN {
        ...
        MESSAGE("Foe Breloom's Effect Spore paralyzed Alakazam! It may be unable to move!");
...
SINGLE_BATTLE_TEST("Effect Spore causes sleep 11% of the time")
{
    ...
    GIVEN {
        ...
        MESSAGE("Foe Breloom's Effect Spore made Alakazam sleep!");
