...
SINGLE_BATTLE_TEST("Wind Power sets up Charge for player when hit by a wind move")
{
    ...
    GIVEN {
        PLAYER(SPECIES_PICHU) { Ability(ABILITY_WIND_POWER); Speed(10); }
        ...
        if (move == MOVE_AIR_CUTTER) {
            ...
            MESSAGE("Being hit by Air Cutter charged Pichu with power!");
        }
...
SINGLE_BATTLE_TEST("Wind Power sets up Charge for opponent when hit by a wind move")
{
    ...
    GIVEN {
        PLAYER(SPECIES_ALAKAZAM) {Ability(ABILITY_LIMBER); Speed(5) ;} // Limber, so it doesn't get paralyzed.
        OPPONENT(SPECIES_PICHU) { Ability(ABILITY_WIND_POWER); Speed(10); }
    } WHEN {
        ...
        if (move == MOVE_AIR_CUTTER) {
            ...
            MESSAGE("Being hit by Air Cutter charged Foe Pichu with power!");
        }
...
DOUBLE_BATTLE_TEST("Wind Power activates correctly for every battler with the ability when hit by a 2/3 target move")
{
    ...
    GIVEN {
        PLAYER(SPECIES_PICHU) { Ability(abilityLeft); Speed(10); }
        PLAYER(SPECIES_PICHU) { Ability(abilityRight); Speed(5); }
        OPPONENT(SPECIES_ALAKAZAM) { Ability(ABILITY_LIMBER); Speed(20); }
        OPPONENT(SPECIES_ALAKAZAM) { Ability(ABILITY_LIMBER); Speed(15); }
    } WHEN {
...
DOUBLE_BATTLE_TEST("Wind Power activates correctly for every battler with the ability when hit by a 3 target move")
{
    ...
    GIVEN {
        ...
        if (abilityLeft == ABILITY_WIND_POWER) {
            ABILITY_POPUP(playerLeft, ABILITY_WIND_POWER);
            MESSAGE("Being hit by Petal Blizzard charged Pichu with power!");
        }
        HP_BAR(playerRight);
        if (abilityRight == ABILITY_WIND_POWER) {
            ABILITY_POPUP(playerRight, ABILITY_WIND_POWER);
...
DOUBLE_BATTLE_TEST("Wind Power activates correctly when Tailwind is used")
{
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_PICHU) { Ability(ABILITY_WIND_POWER); Speed(10); }
        PLAYER(SPECIES_PICHU) { Ability(ABILITY_WIND_POWER); Speed(5); }
        OPPONENT(SPECIES_PICHU) { Ability(ABILITY_WIND_POWER); Speed(20); }
        OPPONENT(SPECIES_PICHU) { Ability(ABILITY_WIND_POWER); Speed(15); }
    } WHEN {
        ...
        if (opponentSide) {
            ...
            MESSAGE("Being hit by Tailwind charged Foe Pichu with power!");
            ...
            ABILITY_POPUP(playerLeft, ABILITY_WIND_POWER);
            MESSAGE("Being hit by Tailwind charged Pichu with power!");
