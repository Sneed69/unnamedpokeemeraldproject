...
SINGLE_BATTLE_TEST("Mummy/Lingering Aroma replace the attacker's ability on contact")
{
    ...
    PARAMETRIZE { move = MOVE_AQUA_JET; ability = ABILITY_MUMMY; species = SPECIES_BANETTE; }
    PARAMETRIZE { move = MOVE_WATER_GUN; ability = ABILITY_MUMMY; species = SPECIES_BANETTE;}
    PARAMETRIZE { move = MOVE_AQUA_JET; ability = ABILITY_LINGERING_AROMA; species = SPECIES_LINOONE; }
    PARAMETRIZE { move = MOVE_WATER_GUN; ability = ABILITY_LINGERING_AROMA; species = SPECIES_LINOONE; }
    GIVEN {
        ...
        if (gMovesInfo[move].makesContact) {
            ...
            if (ability == ABILITY_MUMMY)
                MESSAGE("Alakazam acquired Mummy!");
            else
                MESSAGE("Alakazam acquired Lingering Aroma!");
        } else {
            NONE_OF {
                ABILITY_POPUP(opponent, ability);
                if (ability == ABILITY_MUMMY)
...
SINGLE_BATTLE_TEST("Mummy and Lingering Aroma don't replace each other")
{
    ...
    PARAMETRIZE { ability1 = ability2 = ABILITY_MUMMY; species1 = species2 = SPECIES_BANETTE; }
    PARAMETRIZE { ability1 = ABILITY_MUMMY; species1 = SPECIES_BANETTE; ability2 = ABILITY_LINGERING_AROMA; species2 = SPECIES_LINOONE; }
    PARAMETRIZE { ability1 = ability2 = ABILITY_LINGERING_AROMA; species1 = species2 = SPECIES_LINOONE; }
    GIVEN {
        ASSUME(gMovesInfo[MOVE_AQUA_JET].makesContact);
        ...
        NONE_OF {
            ...
            MESSAGE("Banette acquired Mummy!");
            MESSAGE("Banette acquired Lingering Aroma!");
            MESSAGE("Linoone acquired Mummy!");
            MESSAGE("Linoone acquired Lingering Aroma!");
        }
    }
}
