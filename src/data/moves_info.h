...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SEISMIC_TOSS] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful toss that\n"
            "always inflicts 50 damage."),
        .effect = EFFECT_FIXED_DAMAGE_ARG,
        .power = 1,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_SKY_ATTACK] =
    {
        ...
        .sleepTalkBanned = TRUE,
        .instructBanned = TRUE,
        .argument = TWO_TURN_ARG(STRINGID_CLOAKEDINAHARSHLIGHT, B_WEATHER_WINDY),
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Removes hazards and frees\n"
            "the user. Raises Speed."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_FACADE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Double power if affected\n"
            "by a non-sleep status."),
    ...
    [MOVE_MYSTIC_BLADES] =
    {
        .name = COMPOUND_STRING("Mystic Blades"),
        .description = COMPOUND_STRING(
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SWORDS_DANCE},
        .battleAnimScript = Move_MYSTIC_BLADES,
    },

    [MOVE_FAIRY_TAIL] =
    {
        .name = COMPOUND_STRING("Fairy Tail"),
        .description = COMPOUND_STRING(
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_MISTY_TERRAIN},
        .battleAnimScript = Move_FAIRY_TAIL,
    },
    ...
    [MOVE_COLD_SNAP] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_HAIL},
        .battleAnimScript = Move_COLD_SNAP,
    },

    [MOVE_BLISTERING_COLD] =
    {
        .name = COMPOUND_STRING("Blistering Cold"),
        .description = COMPOUND_STRING(
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_HAIL},
        .battleAnimScript = Move_BLISTERING_COLD,
    },

    [MOVE_HOWLING_GALE] =
    {
        .name = COMPOUND_STRING("Howling Gale"),
        .description = COMPOUND_STRING(
        ...
        .contestComboStarterId = COMBO_STARTER_BRAVE_BIRD,
        .contestComboMoves = {0},
        .battleAnimScript = Move_HOWLING_GALE,
    },
    ...
    [MOVE_MAGIC_FANG] =
    {
        .name = COMPOUND_STRING("Magic Fang"),
        .description = COMPOUND_STRING(
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_MISTY_TERRAIN},
        .battleAnimScript = Move_MAGIC_FANG,
    },
    ...
    [MOVE_STARFALL] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .battleAnimScript = Move_STARFALL,
    },
    ...
    [MOVE_OVERLOAD] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .battleAnimScript = Move_OVERLOAD,
    },
    ...
    [MOVE_MINDSTORM] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .battleAnimScript = Move_MINDSTORM,
    },
    ...
    [MOVE_SNOWSTORM] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .battleAnimScript = Move_SNOWSTORM,
    },
    ...
    [MOVE_LANDSLIDE] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .battleAnimScript = Move_LANDSLIDE,
    },
    ...
    [MOVE_VAMPIRIC_FANG] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_VAMPIRIC_FANG,
    },

    [MOVE_TOPPLE_PSYCHE] =
    {
        .name = COMPOUND_STRING("Topple Psyche"),
        .description = COMPOUND_STRING(
            "High power, but lowers\n"
            "Attack and Defense."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_PSYCHIC,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_LOCK_ON, COMBO_STARTER_MIND_READER},
        .battleAnimScript = Move_TOPPLE_PSYCHE,
    },
    ...
    [MOVE_DUST_DEVIL] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_DUST_DEVIL,
    },
