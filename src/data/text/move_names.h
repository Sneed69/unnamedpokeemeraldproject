const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PARABOLIC_CHARGE] = _("ParabolicCharge"),
    ...
    [MOVE_STEAM_ERUPTION] = _("Steam Erption"),
    ...
    [MOVE_ELECTRIC_TERRAIN] = _("ElectricTerrain"),
    ...
    [MOVE_REVELATION_DANCE] = _("RevelationDance"),
    ...
    [MOVE_STOMPING_TANTRUM] = _("StompingTantrum"),
    ...
    [MOVE_NATURES_MADNESS] = _("Nature's Wrath"),
    ...
    [MOVE_DOUBLE_IRON_BASH] = _("Dual Iron Bash"),
    //GEN 8
    ...
    [MOVE_MISTY_EXPLOSION] = _("Misty Explsion"),
    ...
    [MOVE_MYSTIC_BLADE] = _("Mystic Blade"),
};
