...
static const u8 sFlowerGiftDescription[] = _("Boosts all of the team's\nstats in sunshine.");
...
static const u8 sUnbreakableDescription[] = _("Incoming physical moves\naren't super effective.");
static const u8 sUnthreateningDescription[] = _("Lower's the Defense and\nSp. Def of opposing Pokémon.");
...
static const u8 sTimelessMasterDescription[] = _("Powers up and resists Rock,\nIce and Steel-type moves.");
