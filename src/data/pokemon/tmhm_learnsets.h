...
static const u8 sCharmanderTMHMLearnset[] =
{
    ...
    TMHM(TM17_PROTECT),
    TMHM(TM20_FIRE_FANG),
    TMHM(TM21_THUNDER_PUNCH),
    TMHM(TM23_IRON_TAIL),
    TMHM(TM27_FIRE_PUNCH),
    TMHM(TM28_DIG),
...
static const u8 sEkansTMHMLearnset[] =
{
    ...
    TMHM(TM104_STRENGTH),
    TMHM(TM110_VENOSHOCK),
    TMHM(TM112_SLUDGE_WAVE),
    0xFF,
};

static const u8 sArbokTMHMLearnset[] =
{
    TMHM(TM03_THUNDER_FANG),
    TMHM(TM06_TOXIC),
    TMHM(TM09_SEED_BOMB),
    TMHM(TM10_HIDDEN_POWER),
    TMHM(TM11_SUNNY_DAY),
