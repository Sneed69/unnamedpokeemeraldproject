...
static s32 GetSwitchinWeatherImpact(void)
{
    ...
    if (WEATHER_HAS_EFFECT)
    {
        ...
        if (item != ITEM_SAFETY_GOGGLES)
        {
            ...
            && ability != ABILITY_OVERCOAT && ability != ABILITY_SNOW_CLOAK && ability != ABILITY_ICE_BODY && ability != ABILITY_CRYSTAL_SHROUD)
            {
                ...
                && ability != ABILITY_CRYSTAL_SHROUD && ability != ABILITY_OVERCOAT && ability != ABILITY_SAND_VEIL
                && ability != ABILITY_DESERT_LURKER && ability != ABILITY_SAND_RUSH && ability != ABILITY_SAND_FORCE))
            {
                weatherImpact = maxHP / 16;
                if (weatherImpact == 0)
                    weatherImpact = 1;
