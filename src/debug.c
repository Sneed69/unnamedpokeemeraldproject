...
// Script menu
static const u8 sDebugText_Util_Script_1[] = _("Rain");
static const u8 sDebugText_Util_Script_2[] = _("Thunderstorm");
static const u8 sDebugText_Util_Script_3[] = _("Downpour");
static const u8 sDebugText_Util_Script_4[] = _("Sandstorm");
static const u8 sDebugText_Util_Script_5[] = _("Shade");
static const u8 sDebugText_Util_Script_6[] = _("Drought");
static const u8 sDebugText_Util_Script_7[] = _("Snow");
static const u8 sDebugText_Util_Script_8[] = _("Fog");
// Util Menu
...
static void DebugAction_FlagsVars_FlagsSelect(u8 taskId)
{
    ...
    if (JOY_NEW(DPAD_ANY) || JOY_NEW(A_BUTTON))
    {
        ...
        StringExpandPlaceholders(gStringVar1, sDebugText_FlagsVars_FlagHex);
        if (FlagGet(gTasks[taskId].tInput))
            StringCopyPadded(gStringVar2, sDebugText_True, CHAR_SPACE, 15);
        else
            StringCopyPadded(gStringVar2, sDebugText_False, CHAR_SPACE, 15);
        StringCopy(gStringVar3, gText_DigitIndicator[gTasks[taskId].tDigit]);
...
static void DebugAction_PCBag_Fill_PocketTMHM(u8 taskId)
{
    ...
    for (itemId = ITEM_TM01; itemId <= LAST_TM; itemId++)
    {
