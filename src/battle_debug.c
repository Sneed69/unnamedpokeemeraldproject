...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_DAMP_ROCK_UNUSED] = sText_HoldEffectDampRock,
    [HOLD_EFFECT_GRIP_CLAW] = sText_HoldEffectGripClaw,
    [HOLD_EFFECT_HEAT_ROCK_UNUSED] = sText_HoldEffectHeatRock,
    [HOLD_EFFECT_ICY_ROCK_UNUSED] = sText_HoldEffectIcyRock,
    [HOLD_EFFECT_LIGHT_CLAY] = sText_HoldEffectLightClay,
    [HOLD_EFFECT_WEATHER_STONE] = sText_HoldEffectSmoothRock,
