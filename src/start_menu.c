...
static void ShowTimeWindow(void)
{
    ...
    {
        if (gSaveBlock1Ptr->gameTime.hours == 0)
            convertedHours = 12;
        else
            convertedHours = gSaveBlock1Ptr->gameTime.hours;
        suffix = gText_AM;
    }
    else if (gSaveBlock1Ptr->gameTime.hours == 12)
    {
        convertedHours = 12;
        if (suffix == gText_AM);
            suffix = gText_PM;
    ...
    {
        convertedHours = gSaveBlock1Ptr->gameTime.hours - 12;
        suffix = gText_PM;
    }
