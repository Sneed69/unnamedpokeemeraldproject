...
static const u8 sText_EVO_LEVEL_SHEDINJA[] = _("Level {STR_VAR_2}, empty party slot");
static const u8 sText_EVO_BEAUTY[] = _("Level up, high beauty");
static const u8 sText_EVO_LEVEL_FEMALE[] = _("Level {STR_VAR_2}, female");
static const u8 sText_EVO_LEVEL_MALE[] = _("Level {STR_VAR_2}, male");
