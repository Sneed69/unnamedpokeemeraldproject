...
static const u8 sText_Stats_Attack[] = _("Attack");
static const u8 sText_Stats_Defense[] = _("Defense");
static const u8 sText_Stats_Speed[] = _("Speed");
static const u8 sText_Stats_SpAttack[] = _("Sp. Attack");
static const u8 sText_Stats_SpDefense[] = _("Sp. Defense");
...
static const u8 sText_Stats_Gender_100[] = _("1♀");
static const u8 sText_Stats_Growthrate[] = _("Growth Rate:");
static const u8 sText_Stats_Friendship[] = _("Friendship:");
static const u8 sText_Stats_MEDIUM_FAST[] = _("Medium Fast");
...
static const u8 sText_EVO_Buttons_Decapped_PE[] = _("{DPAD_UPDOWN} Browse  {A_BUTTON} Info {START_BUTTON} Forms");
...
static const u8 sText_EVO_FRIENDSHIP[] = _("Level up, high friendship");
static const u8 sText_EVO_FRIENDSHIP_DAY[] = _("Level up, high friendship, day");
static const u8 sText_EVO_FRIENDSHIP_NIGHT[] = _("Level up, high friendship, night");
static const u8 sText_EVO_FRIENDSHIP_MOVE_TYPE[] = _("Level up, high friendship, {STR_VAR_2} move");
static const u8 sText_EVO_LEVEL[] = _("Level {STR_VAR_2}");
...
static const u8 sText_EVO_LEVEL_ATK_GT_DEF[] = _("Level {STR_VAR_2}, Atk > Def");
static const u8 sText_EVO_LEVEL_ATK_EQ_DEF[] = _("Level {STR_VAR_2}, Atk = Def");
static const u8 sText_EVO_LEVEL_ATK_LT_DEF[] = _("Level {STR_VAR_2}, Atk < Def");
static const u8 sText_EVO_LEVEL_SILCOON[] = _("Level {STR_VAR_2}, randomly");
static const u8 sText_EVO_LEVEL_CASCOON[] = _("Level {STR_VAR_2}, randomly");
static const u8 sText_EVO_LEVEL_NINJASK[] = _("Level {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_SHEDINJA[] = _("Level {STR_VAR_2}, party<6, 1x Pokéball");
static const u8 sText_EVO_BEAUTY[] = _("Level up, high beauty");
static const u8 sText_EVO_LEVEL_FEMALE[] = _("Level {STR_VAR_2}, is female");
static const u8 sText_EVO_LEVEL_MALE[] = _("Level {STR_VAR_2}, is male");
static const u8 sText_EVO_LEVEL_NIGHT[] = _("Level {STR_VAR_2}, night");
static const u8 sText_EVO_LEVEL_DAY[] = _("Level {STR_VAR_2}, day");
static const u8 sText_EVO_LEVEL_DUSK[] = _("Level {STR_VAR_2}, dusk (19:00 to 20:00)");
static const u8 sText_EVO_ITEM_HOLD_DAY[] = _("Level up, holds {STR_VAR_2}, day");
static const u8 sText_EVO_ITEM_HOLD_NIGHT[] = _("Level up, holds {STR_VAR_2}, night");
static const u8 sText_EVO_MOVE[] = _("Level up, knows {STR_VAR_2}");
static const u8 sText_EVO_MAPSEC[] = _("Level up on {STR_VAR_2}");
...
static const u8 sText_EVO_LEVEL_RAIN[] = _("Level {STR_VAR_2} while raining");
static const u8 sText_EVO_SPECIFIC_MON_IN_PARTY[] = _("Level up with {STR_VAR_2} in party");
static const u8 sText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[] = _("Level up with dark type in party");
static const u8 sText_EVO_TRADE_SPECIFIC_MON[] = _("Traded for {STR_VAR_2}");
static const u8 sText_EVO_SPECIFIC_MAP[] = _("Level up on {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_NATURE_AMPED[] = _("Level {STR_VAR_2}, Amped natures");
static const u8 sText_EVO_LEVEL_NATURE_LOW_KEY[] = _("Level {STR_VAR_2}, Low Key natures");
...
static const u8 sText_EVO_ITEM_HOLD[] = _("Level up, holds {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_MOVE_TWENTY_TIMES[] = _("Level up after 20x {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_RECOIL_DAMAGE_MALE[] = _("Level up with {STR_VAR_2} recoil, male");
static const u8 sText_EVO_LEVEL_RECOIL_DAMAGE_FEMALE[] = _("Level up with {STR_VAR_2} recoil, female");
static const u8 sText_EVO_LEVEL_ABILITY[] = _("Level {STR_VAR_2} with {STR_VAR_3}");
static const u8 sText_EVO_LEVEL_MOVE_TYPE[] = _("Level up, knows {STR_VAR_2}-type move");
static const u8 sText_EVO_LEVEL_ITEM_COUNT_999[] = _("Level up with 999 {STR_VAR_2} in bag");
...
static const u8 sText_FORMS_Buttons_Decapped_PE[] = _("{START_BUTTON} Evolution");
static const u8 sText_FORMS_Buttons_Submenu_PE[] = _("{DPAD_NONE}FORMs {A_BUTTON}CHECK {START_BUTTON}EVOs");
static const u8 sText_FORMS_Buttons_Submenu_Decapped_PE[] = _("{START_BUTTON} Evolution");
...
EWRAM_DATA static u16 sStatsMoves[MAX_LEVEL_UP_MOVES] = {0};
...
#define WIN_STATS_BOTTOM_RIGHT 9
...
static const struct WindowTemplate sStatsScreen_WindowTemplates[] =
{
    ...
    [WIN_STATS_MOVES_DESCRIPTION] =
    {
        ...
        .height = 4,
        .paletteNum = 0,
        .baseBlock = 1 + 60 + 40 + 48 + 192 + 24 + 72,
    },
    [WIN_STATS_MOVES_BOTTOM] =
    {
        ...
        .height = 2,
        .paletteNum = 0,
        .baseBlock = 1 + 60 + 40 + 48 + 192 + 24 + 72 + 72,
    },
    [WIN_STATS_BOTTOM_RIGHT] =
    {
        .bg = 2,
        .tilemapLeft = 12,
        .tilemapTop = 12,
        ...
        .height = 8,
        .paletteNum = 0,
        .baseBlock = 1 + 60 + 40 + 48 + 192 + 24 + 72 + 72 + 36,
    },
    DUMMY_WIN_TEMPLATE
};
...
static void CreateInterfaceSprites(u8 page)
{
    ...
    if (page == PAGE_MAIN)
    {
        ...
        // National seen
        CreateSprite(&sSeenOwnTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X, 35 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET + 6, 1);
        // National own
        spriteId = CreateSprite(&sSeenOwnTextSpriteTemplate, LIST_RIGHT_SIDE_TEXT_X, 45 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET + 6, 1);
        StartSpriteAnim(&gSprites[spriteId], 1);

        //****************************
        // National seen value - 1000s
        drawNextDigit = FALSE;
        spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate, counterX1000s, 35 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
        ...
        spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate, counterX100s, 35 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
        ...
        spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate, counterX10s, 35 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
        ...
        spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate, counterX1s, 35 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
        digitNum = ((sPokedexView->seenCount % 1000) % 100) % 10;
        StartSpriteAnim(&gSprites[spriteId], digitNum);

        // National owned value - 1000s
        drawNextDigit = FALSE;
        spriteId = CreateSprite(&sNationalDexSeenOwnNumberSpriteTemplate, counterX1000s, 45 - LIST_RIGHT_SIDE_TEXT_Y_OFFSET, 1);
...
//*                                  *
//************************************
static const u8 sStatsPageNavigationTextColor[] = {TEXT_COLOR_TRANSPARENT, 12, 1};
...
static void StatsPage_PrintNavigationButtons(void)
{
    ...
    if (!HGSS_DECAPPED)
        ...
        AddTextPrinterParameterized3(WIN_STATS_NAVIGATION_BUTTONS, 0, x + 3, y, sStatsPageNavigationTextColor, 0, sText_Stats_Buttons_Decapped);
...
static void PrintStatsScreen_Moves_Top(u8 taskId)
{
    ...
    {
        PrintStatsScreenTextSmall(WIN_STATS_MOVES_TOP, (const u8[])_("On"), moves_x + 113, moves_y + 3);
        PrintStatsScreenTextSmall(WIN_STATS_MOVES_TOP, (const u8[])_("Evo"), moves_x + 113, moves_y + 14);
        item = ITEM_EVIOLITE;
    }
...
static void PrintStatsScreen_NameGender(u8 taskId, u32 num, u32 value)
{
    ...
    case 254:
        ...
        break;
    default:
        PrintStatsScreenTextSmall(WIN_STATS_NAME_GENDER, COMPOUND_STRING("Sex Unknown"), gender_x, gender_y);
        break;
    }
}
...
static void PrintStatsScreen_Left(u8 taskId)
{
    ...
    if (sPokedexView->sPokemonStats.eggGroup1 == sPokedexView->sPokemonStats.eggGroup2)
        ...
        PrintStatsScreenTextSmall(WIN_STATS_LEFT, sText_Stats_EggGroups, base_x, base_y + base_y_offset*base_i);
    base_i++;
...
{
    u32 base_x = 8;
    u32 base_x_offset = 115;
    u32 base_x_first_row = 40;
    u32 base_x_second_row = 60;
    u32 base_y = 6;
    u32 base_y_offset = 11;
    u8 strBase[14];
    u32 base_i = 0;
...
//*                                  *
//************************************
static const u8 sEvoFormsPageNavigationTextColor[] = {TEXT_COLOR_TRANSPARENT, 13, 1};
...
static void EvoFormsPage_PrintNavigationButtons(void)
{
    ...
    FillWindowPixelBuffer(WIN_NAVIGATION_BUTTONS, PIXEL_FILL(0));
        ...
        {
            if (!HGSS_DECAPPED)
                AddTextPrinterParameterized3(WIN_NAVIGATION_BUTTONS, 0, x, y, sStatsPageNavigationTextColor, 0, sText_EVO_Buttons_PE);
            else
                AddTextPrinterParameterized3(WIN_NAVIGATION_BUTTONS, 0, x, y, sStatsPageNavigationTextColor, 0, sText_EVO_Buttons_Decapped_PE);
        }
        else if (sPokedexView->selectedScreen == FORMS_SCREEN)
        {
            ...
            else
            {
                if (!HGSS_DECAPPED)
                    ...
                    AddTextPrinterParameterized3(WIN_NAVIGATION_BUTTONS, 0, x + 6, y, sStatsPageNavigationTextColor, 0, sText_FORMS_Buttons_Decapped_PE);
            }
        }
...
static u8 PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u8 depth_i)
{
    ...
    for (i = 0; i < times; i++)
    {
        ...
        case EVO_LEVEL_ABILITY_2:
            ConvertIntToDecimalStringN(gStringVar2, evolutions[i].param, STR_CONV_MODE_LEADING_ZEROS, 3);
            StringExpandPlaceholders(gStringVar3, gAbilitiesInfo[GetAbilityBySpecies(species, 1)].name);
            StringExpandPlaceholders(gStringVar4, sText_EVO_LEVEL_ABILITY);
            break;
