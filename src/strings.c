...
const u8 gText_EVO_LEVEL[]                          = _("Level up to {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Level up to {STR_VAR_2}, Atk > Def");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Level up to {STR_VAR_2}, Atk = Def");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Level up to {STR_VAR_2}, Atk < Def");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Level up to {STR_VAR_2}, Silcoon persona");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Level up to {STR_VAR_2}, Cascoon persona");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Level up to {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Level up to {STR_VAR_2}, party<6, 1x Pokéball");
const u8 gText_EVO_BEAUTY[]                         = _("Level up, high beauty");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Level up to {STR_VAR_2}, is female");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Level up to {STR_VAR_2}, is male");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Level up to {STR_VAR_2}, night");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Level up to {STR_VAR_2}, day");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("Level up to {STR_VAR_2}, dusk (5-6PM)");
...
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Level up to {STR_VAR_2} while raining");
