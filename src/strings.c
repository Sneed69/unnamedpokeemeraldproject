...
const u8 gText_BoxFull[] = _("The storage system is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThatItemIsSoldOut[] = _("{PLAYER} already owns this item.{PAUSE_UNTIL_PRESS}");
const u8 gText_SoldOut[] = _("Owned");
