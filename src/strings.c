...
const u8 gText_DefaultNameStu[] = _("Steward");
const u8 gText_DefaultNameMilton[] = _("Bobby");
...
const u8 gText_DefaultNameJaxson[] = _("Jax");
const u8 gText_DefaultNameEaston[] = _("Alexander");
const u8 gText_DefaultNameWalker[] = _("Walker");
const u8 gText_DefaultNameTeru[] = _("Ralph");
...
const u8 gText_DefaultNameKimmy[] = _("Kimberly");
const u8 gText_DefaultNameTiara[] = _("Tiara");
const u8 gText_DefaultNameBella[] = _("Bella");
const u8 gText_DefaultNameJayla[] = _("Kayla");
const u8 gText_DefaultNameAllie[] = _("Allie");
const u8 gText_DefaultNameLianna[] = _("Lilianna");
const u8 gText_DefaultNameSara[] = _("Sara");
const u8 gText_DefaultNameMonica[] = _("Monica");
const u8 gText_DefaultNameCamila[] = _("Sapphire");
const u8 gText_DefaultNameAubree[] = _("Aubree");
const u8 gText_DefaultNameRuthie[] = _("Selene");
const u8 gText_DefaultNameHazel[] = _("Hazel");
const u8 gText_DefaultNameNadine[] = _("Alexandra");
const u8 gText_DefaultNameTanja[] = _("Ruby");
const u8 gText_DefaultNameYasmin[] = _("May");
const u8 gText_DefaultNameNicola[] = _("Colette");
const u8 gText_DefaultNameLillie[] = _("Esmeralda");
...
const u8 gText_NumberItem_TM[] = _("{NO}{STR_VAR_1}{CLEAR 0x03}{STR_VAR_2}");
...
const u8 gText_MenuPlayer[] = _("My Info"); //_("{PLAYER}");
...
const u8 gText_MoveRelearnedPkmnDidNotLearnMove[] = _("{STR_VAR_1} did not learn\n{STR_VAR_2}."); // Unused
...
const u8 gText_Stats_Buttons_Decapped[]  = _("{DPAD_UPDOWN} Browse Moves");
const u8 gText_Stats_HP[]       = _("HP");
const u8 gText_Stats_Attack[]   = _("Atk");
const u8 gText_Stats_Defense[]  = _("Def");
const u8 gText_Stats_Speed[]    = _("Speed");
const u8 gText_Stats_SpAttack[]    = _("Sp.Atk");
const u8 gText_Stats_SpDefense[]    = _("Sp.Def");
...
const u8 gText_Stats_On[]     = _("On");
const u8 gText_Stats_Evo[]     = _("Evo");
const u8 gText_Stats_Ability[]      = _("Ability");
const u8 gText_Stats_AbilityFirst[]      = _("First Possible Ability");
const u8 gText_Stats_AbilitySecond[]      = _("Second Possible Ability");
...
const u8 gText_Stats_CatchRate_Legend[]         = _("Very Low");
const u8 gText_Stats_CatchRate_VeryHard[]       = _("Low");
const u8 gText_Stats_CatchRate_Difficult[]      = _("Average");
const u8 gText_Stats_CatchRate_Medium[]         = _("Decent");
const u8 gText_Stats_CatchRate_Relaxed[]        = _("High");
const u8 gText_Stats_CatchRate_Easy[]           = _("Very High");
...
const u8 gText_Stats_Growthrate[]    = _("Growth:");
...
const u8 gText_Stats_MEDIUM_FAST[]   = _("Medium Fast");
const u8 gText_Stats_ERRATIC[]       = _("Erratic");
const u8 gText_Stats_FLUCTUATING[]   = _("Fluctuating");
const u8 gText_Stats_MEDIUM_SLOW[]   = _("Medium Slow");
...
const u8 gText_Stats_EggGroup[]             = _("Egg Group:");
const u8 gText_Stats_EggGroups[]             = _("Egg Groups:");
...
const u8 gText_Stats_eggGroup_UNDISCOVERED[]= _("No Eggs Dicovered");
...
const u8 gText_EVO_FRIENDSHIP[]                     = _("Level up with high friendship");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("Level up with high friendship, day");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("Level up with high friendship, night");
const u8 gText_EVO_LEVEL[]                          = _("Level {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Level {STR_VAR_2}, Atk > Def");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Level {STR_VAR_2}, Atk = Def");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Level {STR_VAR_2}, Atk < Def");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Level {STR_VAR_2}, randomly");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Level {STR_VAR_2}, randomly");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Level {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Level {STR_VAR_2}, party<6, 1x Pokéball");
const u8 gText_EVO_BEAUTY[]                         = _("Level up with high beauty");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Level {STR_VAR_2}, female");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Level {STR_VAR_2}, male");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Level {STR_VAR_2} at night");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Level {STR_VAR_2}, day");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("Level {STR_VAR_2}, dusk (5-6PM)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Level up, holds {STR_VAR_2}, day");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Level up, holds {STR_VAR_2}, night");
const u8 gText_EVO_MOVE[]                           = _("Level up, knows {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("Level up, knows {STR_VAR_2} move");
const u8 gText_EVO_MAPSEC[]                         = _("Level up on {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                      = _("{STR_VAR_2} used on male");
const u8 gText_EVO_ITEM_FEMALE[]                    = _("{STR_VAR_2} used on female");
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Level {STR_VAR_2} while raining");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Level up with {STR_VAR_2} in party");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Level up with Dark type in party");
const u8 gText_EVO_TRADE_SPECIFIC_MON[]             = _("Traded for {STR_VAR_2}");
const u8 gText_EVO_SPECIFIC_MAP[]                   = _("Level up in {STR_VAR_2}");
const u8 gText_EVO_ABILITY[]                    = _("Level {STR_VAR_2} with {STR_VAR_3}");
...
// Exp. Share
const u8 gText_ExpShareOn[] = _("Experience sharing activated.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("Experience sharing deactivated.{PAUSE_UNTIL_PRESS}");

const u8 gText_SoldOut[] = _("You already own a copy of this TM.\p");
const u8 gText_SoldOut2[] = _("Owned");
