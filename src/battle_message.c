...
static const u8 sText_PlayerPaidPrizeMoney[] = _("{B_PLAYER_NAME} lost ¥{B_BUFF1}…\p… … … …\p{B_PLAYER_NAME} whited out!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_TeamGainedEXP[] = _("The rest of the team benefits\nfrom Exp. Share!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_LEGENDARYFENDEDBALLOFF - 12] = sText_LegendaryFendedBallOff,
    ...
    [STRINGID_PKMNALREADYFROZEN - 12] = sText_PkmnIsAlreadyFrozen,
    [STRINGID_PKMNPREVENTSFREEZINGWITH - 12] = sText_PkmnPreventsFreezingWith,
};
...
{
    [B_MSG_ABILITY_PREVENTS_MOVE_STATUS]    = STRINGID_PKMNPREVENTSFREEZINGWITH,
    [B_MSG_ABILITY_PREVENTS_ABILITY_STATUS] = STRINGID_PKMNSXPREVENTSYSZ,
    [B_MSG_STATUS_HAD_NO_EFFECT]            = STRINGID_PKMNSXHADNOEFFECTONY
};
