...
static EWRAM_DATA u32 sBattlerAbilities[MAX_BATTLERS_COUNT][NUM_ABILITIES] = {0};
...
static const u8 sText_PkmnGotFrostbite[] = _("{B_EFF_NAME_WITH_PREFIX} was frostbitten!");
...
static const u8 sText_PkmnFrostbittenBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}\ngave {B_EFF_NAME_WITH_PREFIX} frostbite!");
...
static const u8 sText_PkmnIsAlreadyFrostbitten[] = _("{B_DEF_NAME_WITH_PREFIX} is\nalready frostbitten!");
...
static const u8 sText_PkmnCantUseMoveFlamboyant[] = _("{B_ATK_NAME_WITH_PREFIX}'s flamboyant style\nprevents repeating the same move!\p");
...
static const u8 sText_PkmnMadeItRain[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nmade it rain!");
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised its Speed!");
static const u8 sText_PkmnProtectedBy[] = _("{B_DEF_NAME_WITH_PREFIX} was protected\nby {B_LAST_ABILITY}!");
static const u8 sText_PkmnPreventsUsage[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents {B_ATK_NAME_WITH_PREFIX}\lfrom using {B_CURRENT_MOVE}!");
static const u8 sText_PkmnRestoredHPUsing[] = _("{B_DEF_NAME_WITH_PREFIX} restored HP\nusing its {B_LAST_ABILITY}!");
static const u8 sText_PkmnsXMadeYUseless[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nmade {B_CURRENT_MOVE} useless!");
static const u8 sText_PkmnChangedTypeWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nmade it the {B_BUFF1} type!");
static const u8 sText_PkmnPreventsParalysisWith[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents paralysis!");
static const u8 sText_PkmnPreventsRomanceWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents romance!");
static const u8 sText_PkmnPreventsPoisoningWith[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents poisoning!");
static const u8 sText_PkmnPreventsFrostbiteWith[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents frostbite!");
static const u8 sText_PkmnPreventsConfusionWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents confusion!");
static const u8 sText_PkmnRaisedFirePowerWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised its Fire power!");
static const u8 sText_PkmnAnchorsItselfWith[] = _("{B_DEF_NAME_WITH_PREFIX} anchors\nitself with {B_LAST_ABILITY}!");
static const u8 sText_PkmnCutsAttackWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s Attack!");
static const u8 sText_PkmnLoweredGuard[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nlowers {B_DEF_NAME_WITH_PREFIX}'s guard!");
static const u8 sText_PkmnGuardNotLowered[] = _("{B_DEF_NAME_WITH_PREFIX}'s Defense\nand Sp. Def rose!");
static const u8 sText_PkmnPreventsStatLossWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents stat loss!");
...
static const u8 sText_PkmnsXBlocksY[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nblocks {B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXBlocksY2[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nblocks {B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nrestored its HP a little!");
static const u8 sText_PkmnsXRestoredHP[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nrestored its HP!");
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nwhipped up a sandstorm!");
static const u8 sText_PkmnsXIntensifiedSun[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nintensified the sun's rays!");
static const u8 sText_PkmnsXPreventsYLoss[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents {B_BUFF1} loss!");
static const u8 sText_PkmnsXInfatuatedY[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ninfatuated {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnsXMadeYIneffective[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nmade {B_CURRENT_MOVE} ineffective!");
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ncured its {B_BUFF1} problem!");
...
static const u8 sText_PkmnsXTookAttack[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ntook the attack!");
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_BUFF1}'s {B_LAST_ABILITY}\nprevents switching!\p");
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevented {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s\l{B_BUFF1} from working!");
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nmade it ineffective!");
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents flinching!");
static const u8 sText_PkmnsXPreventsYsZ[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents {B_DEF_NAME_WITH_PREFIX}'s\l{B_LAST_ABILITY} from working!");
static const u8 sText_PkmnsAbilityPreventsAbility[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents {B_DEF_NAME_WITH_PREFIX}'s\l{B_LAST_ABILITY} from working!");
static const u8 sText_PkmnsXCuredItsYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ncured its {B_BUFF1} problem!");
static const u8 sText_PkmnsXHadNoEffectOnY[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nhad no effect on {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_BarelyMadeAScratch[] = _("It barely made a scratch…");
static const u8 sText_NotEffectiveAtAll[] = _("It's not effective at all…");
...
static const u8 sText_ItsDevasting[] = _("It's devastating!");
...
static const u8 sText_LegendaryPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wants to battle!\p{B_OPPONENT_MON1_NAME}'s aura is overwhelming!\nIts power is undeniable!\p");
...
// New battle strings.
static const u8 sText_EnduredViaSturdy[] = _("{B_DEF_NAME_WITH_PREFIX} softened the\nblow using {B_LAST_ABILITY}!");
...
static const u8 sText_TargetAbilityActivates[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} activates!");
...
static const u8 sText_TargetAbilityRaisedStat[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised its {B_BUFF1}!");
static const u8 sText_TargetAbilityLoweredStat[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nlowered its {B_BUFF1}!");
static const u8 sText_AttackerAbilityRaisedStat[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised its {B_BUFF1}!");
static const u8 sText_ScriptingAbilityRaisedStat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised its {B_BUFF1}!");
static const u8 sText_AuroraVeilEnds[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nwore off!");
...
static const u8 sText_MistyTerrainEnds[] = _("The mystifying aura disappeared.");
static const u8 sText_PsychicTerrainEnds[] = _("The telepathic aura disappeared.");
static const u8 sText_GrassyTerrainEnds[] = _("The verdant aura disappeared.");
static const u8 sText_TargetsStatWasMaxedOut[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} maxed\nits {B_BUFF1}!");
...
static const u8 sText_TurboblazeEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} destroys the mold!");
...
static const u8 sText_SolarPowerHpDrop[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ntakes its toll!");
static const u8 sText_DefDelayedDmgWithAbility[] = _("{B_DEF_NAME_WITH_PREFIX} delayed some of the\ndamage using {B_LAST_ABILITY}!");
...
static const u8 sText_ForewarnActivates[] = _("{B_LAST_ABILITY} alerted {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nto {B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!");
static const u8 sText_ForewarnActivates2[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} disabled\n{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!");
static const u8 sText_IceBodyHpGain[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nhealed it a little bit!");
static const u8 sText_SnowWarningHail[] = _("It started to hail!");
static const u8 sText_SnowWarningSnow[] = _("It started to snow!");
static const u8 sText_FriskActivates[] = _("{B_ATK_NAME_WITH_PREFIX} frisked {B_DEF_NAME_WITH_PREFIX} and\n{B_BUFF1} its {B_LAST_ITEM}!");
static const u8 sText_Found[] = _("found");
static const u8 sText_Disabled[] = _("disabled");
static const u8 sText_UnnerveEnters[] = _("The opposing team is too nervous\nto eat Berries!");
static const u8 sText_HarvestBerry[] = _("{B_ATK_NAME_WITH_PREFIX} replenished\nits {B_LAST_ITEM} with {B_LAST_ABILITY}!");
...
static const u8 sText_ProteanTypeChange[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} transformed\nit into the {B_BUFF1} type!");
...
static const u8 sText_TerrainBecomesPolluted[] = _("A noxious aura envelops\nthe battlefield!");
static const u8 sText_TerrainBecomesMisty[] = _("A mystifying aura envelops\nthe battlefield!");
static const u8 sText_TerrainBecomesGrassy[] = _("A verdant aura envelops\nthe battlefield!");
static const u8 sText_TerrainBecomesElectric[] = _("An electrifying aura envelops\nthe battlefield!");
static const u8 sText_TerrainBecomesPsychic[] = _("A telepathic aura envelops\nthe battlefield!");
...
static const u8 sText_MistyTerrainPreventsStatus[] = _("{B_DEF_NAME_WITH_PREFIX} is protected by\nthe mystifying aura!");
static const u8 sText_PollutedTerrainPreventsCuring[] = _("The noxious aura prevents\ncuring status conditions!");
static const u8 sText_GrassyTerrainHeals[] = _("{B_ATK_NAME_WITH_PREFIX} is healed\nby the verdant aura!");
static const u8 sText_ElectricTerrainPreventsSleep[] = _("The electrifying aura\nprevents sleep!");
static const u8 sText_PsychicTerrainPreventsPriority[] = _("{B_DEF_NAME_WITH_PREFIX} is protected by\nthe telepathic aura!");
...
static const u8 sText_ReceiverAbilityTakeOver[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nwas taken over!");
...
static const u8 sText_AuraFlaredToLife[] = _("{B_DEF_NAME}'s power is amplified\nin its own territory!");
...
static const u8 sText_BattlerAbilityRaisedStat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised its {B_BUFF1}!");
static const u8 sText_BattlerAbilityRaisedAllStats[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nraised all its stats!");
...
static const u8 sText_AbilityRaisedStatDrastically[] = _("{B_LAST_ABILITY} raised {B_DEF_NAME_WITH_PREFIX}'s\n{B_BUFF1} drastically!");
...
static const u8 sText_TerrainReturnedToNormal[] = _("The strange aura disappeared!");
...
static const u8 sText_PkmnKickedUpStorm[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nkicked up a storm!");
...
static const u8 sText_AbilityAllowsOnlyMove[] = _("{B_LAST_ABILITY} allows the\nuse of only {B_CURRENT_MOVE}!\p");
...
static const u8 sText_BoosterEnergyActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} used its Booster Energy\nto activate {B_LAST_ABILITY}!");
static const u8 sText_ElectricTerrainActivatedAbility[] = _("The electrifying aura activated\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
static const u8 sText_AbilityWeakenedSurroundingMonsStat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nweakened the {B_BUFF1} of\lall surrounding Pokémon!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_SCRIPTINGAINTED - BATTLESTRINGS_TABLE_START] = sText_ScriptingFainted,
    ...
    [STRINGID_PKMNCANTUSEMOVEFLAMBOYANT - BATTLESTRINGS_TABLE_START] = sText_PkmnCantUseMoveFlamboyant,
    ...
    [STRINGID_STRINGID_NOTVERYEFFECTIVE_x0_125 - BATTLESTRINGS_TABLE_START] = sText_BarelyMadeAScratch,
    [STRINGID_STRINGID_NOTVERYEFFECTIVE_x0_25 - BATTLESTRINGS_TABLE_START] = sText_NotEffectiveAtAll,
    ...
    [STRINGID_SUPEREFFECTIVE_x4 - BATTLESTRINGS_TABLE_START] = sText_ExtremelyEffective,
    [STRINGID_SUPEREFFECTIVE_x8 - BATTLESTRINGS_TABLE_START] = sText_ItsDevasting,
    ...
    [STRINGID_POLLUTEDTERRAINENDS - BATTLESTRINGS_TABLE_START] = sText_PollutedTerrainEnds,
    ...
    [STRINGID_FOREWARNDISABLES - BATTLESTRINGS_TABLE_START] = sText_ForewarnActivates2,
    ...
    [STRINGID_TERRAINBECOMESPOLLUTED - BATTLESTRINGS_TABLE_START] = sText_TerrainBecomesPolluted,
    ...
    [STRINGID_POLLUTEDTERRAINPREVENTS - BATTLESTRINGS_TABLE_START] = sText_PollutedTerrainPreventsCuring,
    ...
    [STRINGID_PKMNALREADYFROSTBITTEN - BATTLESTRINGS_TABLE_START] = sText_PkmnIsAlreadyFrostbitten,
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_TERRAIN_SET_POLLUTED] = STRINGID_TERRAINBECOMESPOLLUTED,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_POLLUTED] = STRINGID_POLLUTEDTERRAINENDS,
};
...
const u16 gTerrainPreventsStringIds[] =
{
    ...
    [B_MSG_TERRAINPREVENTS_POLLUTED] = STRINGID_POLLUTEDTERRAINPREVENTS
};
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_FOREWARN_DISABLE] = STRINGID_FOREWARNDISABLES,
...
{
    [B_MSG_ABILITY_PREVENTS_MOVE_STATUS]    = STRINGID_PKMNPREVENTSFROSTBITEWITH,
    [B_MSG_ABILITY_PREVENTS_ABILITY_STATUS] = STRINGID_PKMNSXPREVENTSYSZ,
    [B_MSG_STATUS_HAD_NO_EFFECT]            = STRINGID_PKMNSXHADNOEFFECTONY
};
...
void BufferStringBattle(u16 stringID, u32 battler)
{
    ...
    for (i = 0; i < MAX_BATTLERS_COUNT; i++)
    {
        for (j = 0; j < NUM_ABILITIES; j++)
            sBattlerAbilities[i][j] = gBattleMsgDataPtr->abilities[i][j];
    }
