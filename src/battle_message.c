...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNALREADYFROSTBITTEN - BATTLESTRINGS_TABLE_START] = sText_PkmnIsAlreadyFrozen,
    [STRINGID_PKMNPREVENTSFROSTBITEWITH - BATTLESTRINGS_TABLE_START] = sText_PkmnPreventsFreezingWith,
