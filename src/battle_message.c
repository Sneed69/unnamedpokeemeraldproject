...
static const u8 sText_PkmnPreventsLoweringOwnStats[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nprevents lowering its own stats!");
...
static const u8 sText_PkmnsXRestoredHP[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nrestored its HP!");
...
static const u8 sText_ForewarnActivates2[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} disabled\n{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!");
...
static const u8 sText_HarvestBerry[] = _("{B_ATK_NAME_WITH_PREFIX} replenished\nits {B_LAST_ITEM} with {B_ATK_ABILITY}!");
static const u8 sText_LastAbilityRaisedBuff1[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nraised its {B_BUFF1}!");
...
static const u8 sText_HealerCure[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ncured {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s problem!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PREVENTSLOWERINGOWNSTATS - BATTLESTRINGS_TABLE_START] = sText_PkmnPreventsLoweringOwnStats,
...
void BufferStringBattle(u16 stringID, u32 battler)
{
    ...
    gLastAbility = gBattleMsgDataPtr->lastAbility;
    ...
    while (*src != EOS)
    {
        ...
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_LAST_ABILITY: // last used ability
                toCpy = gAbilitiesInfo[gLastAbility].name;
                break;
            case B_TXT_ATK_ABILITY: // attacker ability
                toCpy = gAbilitiesInfo[gLastUsedAbilities[gBattlerAttacker]].name;
                break;
            case B_TXT_DEF_ABILITY: // target ability
                toCpy = gAbilitiesInfo[gLastUsedAbilities[gBattlerTarget]].name;
                break;
            case B_TXT_SCR_ACTIVE_ABILITY: // scripting active ability
                toCpy = gAbilitiesInfo[gLastUsedAbilities[gBattleScripting.battler]].name;
                break;
            case B_TXT_EFF_ABILITY: // effect battler ability
                toCpy = gAbilitiesInfo[gLastUsedAbilities[gEffectBattler]].name;
                break;
