...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_FROSMOTH - 1]      = ANIM_SHAKE_GLOW_WHITE_SLOW,
    ...
    [SPECIES_CUFANT - 1]        = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_COPPERAJAH - 1]    = ANIM_ROTATE_UP_SLAM_DOWN,
...
void SetWildMonHeldItem(void)
{
    if (!(gBattleTypeFlags & (BATTLE_TYPE_LEGENDARY | BATTLE_TYPE_TRAINER | BATTLE_TYPE_PYRAMID | BATTLE_TYPE_PIKE)))
    {
        u16 rnd;
        u16 species;
        u16 chanceNoItem = 100 - ITEM_CHANCE_COMMON - ITEM_CHANCE_RARE;
        u16 chanceNotRare = 100 - ITEM_CHANCE_RARE;
