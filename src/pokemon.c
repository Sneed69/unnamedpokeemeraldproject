...
const struct NatureInfo gNaturesInfo[NUM_NATURES] =
{
    [NATURE_HARDY] =
    {
        ...
        .majorProficiency = STAT_ATK,
        .minorProficiency = STAT_HP,
        .backAnim = 0,
    ...
    [NATURE_GRUMPY] =
    {
        .name = COMPOUND_STRING("Grumpy"),
        .majorProficiency = STAT_HP,
        .minorProficiency = STAT_DEF,
        .backAnim = 1,
        .pokeBlockAnim = {ANIM_TIMID, AFFINE_NONE},
        .natureGirlMessage = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
    ...
    [NATURE_COLLECTED] =
    {
        .name = COMPOUND_STRING("Collected"),
        .majorProficiency = STAT_HP,
        .minorProficiency = STAT_SPDEF,
        .backAnim = 1,
        .pokeBlockAnim = {ANIM_CALM, AFFINE_NONE},
    ...
    [NATURE_REGAL] =
    {
        .name = COMPOUND_STRING("Regal"),
        .majorProficiency = STAT_HP,
        .minorProficiency = STAT_SPATK,
        .backAnim = 1,
        .pokeBlockAnim = {ANIM_GENTLE, AFFINE_NONE},
        .natureGirlMessage = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
        .battlePalacePercents = PALACE_STYLE(56, 22, 56, 22), //22%, 22%
        .battlePalaceFlavorText = B_MSG_EAGER_FOR_MORE,
        .battlePalaceSmokescreen = PALACE_TARGET_STRONGER,
    ...
    [NATURE_FREESPIRITED] =
    {
        .name = COMPOUND_STRING("Free-Spirited"),
        .majorProficiency = STAT_HP,
        .minorProficiency = STAT_ATK,
        .backAnim = 1,
        .pokeBlockAnim = {ANIM_HASTY, AFFINE_NONE},
...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV, u8 hasFixedPersonality, u32 fixedPersonality, u8 otIdType, u32 fixedOtId)
{
    ...
    {
        if (gNaturesInfo[personality % NUM_NATURES].majorProficiency == value)
            SetBoxMonData(boxMon, MON_DATA_MAJOR_PROFICIENCY, &value);
        else if (gNaturesInfo[personality % NUM_NATURES].minorProficiency == value)
...
void CreateMaleMon(struct Pokemon *mon, u16 species, u8 level)
{
    ...
    SetMonData(mon, MON_DATA_MINOR_PROFICIENCY, &personality);
    personality = STAT_ATK;
    SetMonData(mon, MON_DATA_MAJOR_PROFICIENCY, &personality);
}
...
u8 GetTMTutorMoves(struct Pokemon *mon, u16 *moves)
{
    ...
    u8 numMoves = 0;
    u16 species = GetMonData(mon, MON_DATA_SPECIES);
    u16 allMoves[LAST_TM - ITEM_TM01 + 1];
    u32 i, j, k;
    u32 totalMoveCount = 0;

    for (i = ITEM_TM01; i < LAST_TM; i++)
    {
