...
void InitRegionMapData(struct RegionMap *regionMap, const struct BgTemplate *template, bool8 zoomed)
{
    ...
    sRegionMap->inputCallback = zoomed ? ProcessRegionMapInput_Zoomed : ProcessRegionMapInput_Full;
    if (template != NULL)
    {
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_ROUTE_117:
        return FlagGet(FLAG_LANDMARK_POKEMON_DAYCARE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_121:
        return FlagGet(FLAG_VISITED_SAFARI_ENTRANCE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_122:
        return FlagGet(FLAG_VISITED_MT_PYRE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_123:
        return FlagGet(FLAG_LANDMARK_BERRY_MASTERS_HOUSE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_124:
        return FlagGet(FLAG_LANDMARK_HUNTERS_HOUSE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_125:
        return FlagGet(FLAG_VISITED_SHOAL_CAVE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_126:
        return FlagGet(FLAG_VISITED_ROUTE126) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_127:
        return FlagGet(FLAG_VISITED_ROUTE127) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_128:
        return FlagGet(FLAG_VISITED_ROUTE128) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_129:
        return FlagGet(FLAG_VISITED_ROUTE129) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_130:
        return FlagGet(FLAG_VISITED_ROUTE130) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    ...
    case MAPSEC_ROUTE_132:
        return FlagGet(FLAG_VISITED_ROUTE133) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
    case MAPSEC_ROUTE_133:
        return FlagGet(FLAG_VISITED_ROUTE134) ? MAPSECTYPE_ROUTE : MAPSECTYPE_ROUTE_CANTFLY;
