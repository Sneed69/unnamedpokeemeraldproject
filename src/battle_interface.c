...
void UpdateAbilityPopup(u8 battlerId)
{
    ...
    u16 ability = (gBattleScripting.abilityPopupOverwrite != 0) ? gBattleScripting.abilityPopupOverwrite : gLastUsedAbilities[battlerId];//gBattleMons[battlerId].ability;
