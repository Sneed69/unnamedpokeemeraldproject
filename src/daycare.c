...
} sIncenseBabyTable[] =
{
    ...
    { SPECIES_ROSELIA,      ITEM_ODD_INCENSE, SPECIES_BUDEW },
...
u8 GetFirstStageEggMovesBySpecies(u16 species, u16 *moves)
{
    return GetEggMovesBySpecies(GetEggSpecies(species), moves);
}
