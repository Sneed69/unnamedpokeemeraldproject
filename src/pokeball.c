...
static void SpriteCB_OpponentMonSendOut2(struct Sprite *sprite);
...
#define GFX_TAG_LITTLE_BALL  55014
...
#define GFX_TAG_AQUA_BALL    55023
#define GFX_TAG_MAGMA_BALL   55024
#define GFX_TAG_WING_BALL    55025
...
const struct CompressedSpriteSheet gBallSpriteSheets[POKEBALL_COUNT] =
{
    ...
    [BALL_LITTLE]  = {gBallGfx_Level,   384, GFX_TAG_LITTLE_BALL},
    ...
    [BALL_AQUA]    = {gBallGfx_Aqua,    384, GFX_TAG_AQUA_BALL},
    [BALL_MAGMA]   = {gBallGfx_Magma,   384, GFX_TAG_MAGMA_BALL},
    [BALL_WING]    = {gBallGfx_Wing,    384, GFX_TAG_WING_BALL},
...
const struct CompressedSpritePalette gBallSpritePalettes[POKEBALL_COUNT] =
{
    ...
    [BALL_LITTLE]  = {gBallPal_Level,   GFX_TAG_LITTLE_BALL},
    ...
    [BALL_AQUA]    = {gBallPal_Aqua,    GFX_TAG_AQUA_BALL},
    [BALL_MAGMA]   = {gBallPal_Magma,   GFX_TAG_MAGMA_BALL},
    [BALL_WING]    = {gBallPal_Wing,    GFX_TAG_WING_BALL},
...
const struct SpriteTemplate gBallSpriteTemplates[POKEBALL_COUNT] =
{
    ...
    [BALL_LITTLE] =
    {
        .tileTag = GFX_TAG_LITTLE_BALL,
        .paletteTag = GFX_TAG_LITTLE_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    [BALL_AQUA] =
    {
        .tileTag = GFX_TAG_AQUA_BALL,
        .paletteTag = GFX_TAG_AQUA_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    [BALL_MAGMA] =
    {
        .tileTag = GFX_TAG_MAGMA_BALL,
        .paletteTag = GFX_TAG_MAGMA_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    [BALL_WING] =
    {
        .tileTag = GFX_TAG_WING_BALL,
        .paletteTag = GFX_TAG_WING_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
...
static void SpriteCB_OpponentMonSendOut(struct Sprite *sprite)
{
    ...
    sprite->oam.affineParam = sprite->sBattler;
    InitAnimArcTranslation(sprite);
    sprite->callback = SpriteCB_OpponentMonSendOut2;
}
