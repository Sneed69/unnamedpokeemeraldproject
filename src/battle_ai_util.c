...
static const s8 sAiAbilityRatings[ABILITIES_COUNT] =
{
    ...
    [ABILITY_FUR_COAT] = 7,
    [ABILITY_PRISTINE_PLUMAGE] = 7,
    [ABILITY_GALE_WINGS] = 8,
    [ABILITY_GALVANIZE] = 8,
    [ABILITY_GLUTTONY] = 3,
    [ABILITY_GOOEY] = 5,
    ...
    [ABILITY_TECTONIC_BALANCE] = 7,
    [ABILITY_ABSOLUTE_ZERO] = 7,
    [ABILITY_PERFECT_ALLOY] = 7,
    [ABILITY_MASTER_OF_THE_AGES] = 9,
    [ABILITY_STENCH] = 1,
...
bool32 ShouldAbsorb(u32 battlerAtk, u32 battlerDef, u32 move, s32 damage)
{
    if (move == 0xFFFF || AI_WhoStrikesFirst(battlerAtk, battlerDef, move) == AI_IS_FASTER)
    {
        ...
        if (gStatuses3[battlerAtk] & STATUS3_HEAL_BLOCK || gBattleMons[battlerAtk].ability == ABILITY_WONDER_GUARD)
            healDmg = 0;
...
bool32 PartnerMoveEffectIsStatusSameTarget(u32 battlerAtkPartner, u32 battlerDef, u32 partnerMove)
{
    ...
    if (gChosenMoveByBattler[battlerAtkPartner] != MOVE_NONE
     ...
     && (gBattleMoves[partnerMove].effect == EFFECT_SLEEP
       ...
       || gBattleMoves[partnerMove].effect == EFFECT_COLD_SNAP
...
s32 AI_CalcPartyMonBestMoveDamage(u32 battlerAtk, u32 battlerDef, struct Pokemon *attackerMon, struct Pokemon *targetMon)
{
    ...
    if (attackerMon != NULL)
        PokemonToBattleMon(attackerMon, &gBattleMons[battlerAtk], TRUE);
    if (targetMon != NULL)
        PokemonToBattleMon(targetMon, &gBattleMons[battlerDef], TRUE);
